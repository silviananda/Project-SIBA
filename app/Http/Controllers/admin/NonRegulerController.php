...
class NonRegulerController extends Controller
{
    ...
    {
        $biodata_mhs = MhsReguler::with(['data_pembimbing_ta', 'kategori_status_mhs', 'kategori_jalur', 'data_pembimbing_ta.dosen'])->where('id_status', '2')->where('user_id', Auth::user()->kode_ps);
    ...
    public function store(Request $request)
    {
        ...
        if (count(array_unique($nip_dosen)) < 5) {
            return redirect('/mahasiswa/non-reguler/')->with(['error' => 'Dosen Penguji atau Dosen Pembimbing tidak boleh sama!']);
        };
        ...
        return redirect('/mahasiswa/non-reguler/')->with(['added' => 'Data Mahasiswa Non Reguler berhasil ditambahkan!']);
    }
    ...
    public function update(Request $request, MhsReguler $mhsReguler, $id)
    {
        ...
        return redirect('/mahasiswa/non-reguler/')->with(['edit' => 'Data Mahasiswa Non Reguler berhasil diubah!']);
    }
    ...
    private function moveToAlumni($data)
    {
        ...
        return redirect('/mahasiswa/non-reguler/')->with(['edit' => 'Data Mahasiswa Non Reguler berhasil dipindahkan ke Data Alumni!']);
    }
