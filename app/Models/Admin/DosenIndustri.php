...
class DosenIndustri extends Model
{
    ...
    protected $fillable = ['nidn', 'nip', 'jabatan_id', 'pendidikan_id', 'bidang', 'sertifikasi', 'sertifikat_pendidik', 'sertifikat_kompetensi', 'sinta', 'scopus', 'wos', 'pend_s1', 'pend_s2', 'pend_s3', 'golongan', 'tempat', 'tgl_lahir', 'jenis_dosen', 'perusahaan'];
