	...
	<div class="">
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
                ...
                <form role="form" action="{{ route('alumni.import.store') }}" method="post" enctype="multipart/form-data">
					@csrf

                    <div class="form-group">
                        <label for="softcopy">Data Alumni</label>
						...
						<div class="form-group">
							<label for="softcopy"><span class="danger" style="color: #DC143C;">*  Contoh Format File yang Dapat di Import</span></label>
                                ...
                                <img src="/assets/images/excel.png" height="50" width="50">
             						<span class="count_top"><i class=""></i> alumni.xlsx </span>
                                ...
                                <div class="message_wrapper">
                                  <p class="url">
                                    ...
                                    <a href="{{ asset('file/alumni.xlsx') }}" target="_blank" data-original-title="">Download</a>
                                  </p>
                                </div>
								</div>
						</div>
