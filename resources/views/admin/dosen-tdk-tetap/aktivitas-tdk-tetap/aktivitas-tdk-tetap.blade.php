  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Aktivitas Dosen Tidak Tetap</h3>
      </div>
        ...
        <div class="x_panel">
          <div class="x_title">
            <ul class="nav navbar-right panel_toolbox">
              <li><a class="" style="color: #778899" href="{{ route('dosen.tidak-tetap.aktivitas.create') }}"> Tambah <i class="fa fa-plus"></i></a>
              </li>
            </ul>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="display: inline-flex;">
                          <a href="{{ route('dosen.tidak-tetap.aktivitas.edit', $value->id) }}" class="btn btn-success btn-sm" style="width: 60%;">Ubah</a>

                          <a href="#" data-id="{{ $value->id }}" class="btn btn-danger btn-sm swal-confirm">
                            <form class="d-inline" action="{{ route('dosen.tidak-tetap.aktivitas.delete', $value->id) }}" id="delete{{ $value->id }}" method="post">
                              @method('delete')
                              @csrf
                            </form>
                            Hapus
