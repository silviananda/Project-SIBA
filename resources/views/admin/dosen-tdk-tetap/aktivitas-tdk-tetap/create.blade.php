	...
	<div class="">
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
					<h2>Form Tambah Data Aktivitas Dosen Tidak Tetap</h2>
					<ul class="nav navbar-right panel_toolbox"></ul>
					<div class="clearfix"></div>
				</div>

				<form role="form" action="{{ route('dosen.tidak-tetap.aktivitas.store') }}" method="post">
					@csrf
					<div class="x_panel">
						<div class="x_title">
						...
						<div class="x_content">
							...
							<div class="row">
								...
								<div class="x_content">
									...
									<a href="{{ route('dosen.tidak-tetap.aktivitas.index') }}" class="btn btn-danger" style="float: right;">Batal</a>
