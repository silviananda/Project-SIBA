		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
				  ...
				  <h2>Form Ubah Data Mahasiswa Non Reguler</h2>
					<ul class="nav navbar-right panel_toolbox"></ul>
					<div class="clearfix"></div>
			    </div>

					<form role="form" action="{{ route('mahasiswa.non-reguler.update', $biodata_mhs->id) }}" method="post">
					@method('patch')
					@csrf
					...
					<div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Tahun Masuk<span class="danger" style="color: #DC143C;">*</span></label>
                                <input id="tahun_masuk" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" onfocus="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" name="tahun_masuk" value="{{ $biodata_mhs->tahun_masuk }}">
                                    <script>
					...
					<div class="x_panel">
                        ...
                        <a href="{{ route('mahasiswa.non-reguler.index') }}" class="btn btn-danger" style="float: right;">Batal</a>
