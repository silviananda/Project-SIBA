                ...
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <h2><i class="fa fa-align-left"></i> Data Biodata Mahasiswa Non Reguler</h2>
                            @if($biodata_mhs->deleted_at != NULL)
                                <ul class="nav navbar-right panel_toolbox"></ul>
                            @else
                                <ul class="nav navbar-right panel_toolbox">
                                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                    <li><a href="{{ route('mahasiswa.non-reguler.edit', $biodata_mhs->id) }}"><i class="fa fa-wrench" style="color: #778899"></i></a></li>
                                </ul>
                            @endif
