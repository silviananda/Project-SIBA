		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
					...
					<form role="form" action="{{ route('dosen.industri.biodata.store') }}" method="post">
					@csrf
						...
						<select id="seeAnotherFieldGroupPerusahaan" name="jenis_dosen" class="form-control @error('jenis_dosen') is-invalid @enderror">
                        ...
                        <div class="form-group" id="otherFieldGroupDivPerusahaan">
                            <div class="row">
                                <div class="col-12">
                                    <label for="otherFieldPerusahaan">Perusahaan/Industri</label>
                                        <input type="text" class="form-control w-100" id="otherFieldPerusahaan" name="perusahaan" value="">
                                </div>
                            </div>
                        </div>
                        <br>
