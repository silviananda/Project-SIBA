    ...
    <div class="">
        <div class="col-md-12 col-sm-12">
            <div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
                ...
                <form role="form" action="{{ route('dosen.industri.aktivitas.update', $aktivitas->id) }}" method="post">
                    @method('patch')
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="dosen-tetap form-control @error('nama_dosen') is-invalid @enderror" disabled="disabled" id="nama_dosen" placeholder="" name="nama_dosen" value="{{ $aktivitas->dosen['nama_dosen'] }}">
                                    </div>
                                    ...
                                    <div id="ps_sendiri_fields">
                                        ...
                                        <div class="form-group kode-{{$item->kurikulum->id ?? null}}">
                                            <div class="input-ps-sendiri form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput1">Jenis Mata Kuliah<span class="required">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput1">Kode Mata Kuliah<span class="required">*</span></label>
