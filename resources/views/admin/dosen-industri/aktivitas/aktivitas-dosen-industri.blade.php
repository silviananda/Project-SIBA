  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Aktivitas Dosen Industri</h3>
      </div>
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
          <div class="x_title">
            <ul class="nav navbar-right panel_toolbox">
              <li><a class="" style="color: #778899" href="{{ route('dosen.industri.aktivitas.create') }}"> Add New <i class="fa fa-plus"></i></a>
              </li>
            </ul>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="display: inline-flex;">
                          <a href="{{ route('dosen.industri.aktivitas.edit', $value->id) }}" class="btn btn-success btn-sm">Edit</a>

                          <a href="#" data-id="{{ $value->id }}" class="btn btn-danger btn-sm swal-confirm">
                            <form class="d-inline" action="{{ route('dosen.industri.aktivitas.delete', $value->id) }}" id="delete{{ $value->id }}" method="post">
                              @method('delete')
                              @csrf
                            </form>
                            Delete
