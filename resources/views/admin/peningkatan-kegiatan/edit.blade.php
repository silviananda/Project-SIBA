		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
				    ...
				    <h2>Form Ubah Data Peningkatan Kegiatan</h2>
					<ul class="nav navbar-right panel_toolbox"></ul>
					<div class="clearfix"></div>
			    </div>

					<form role="form" action="{{ route('kegiatan-akademik.update', $kegiatan->id) }}" method="post">
					@method('patch')
					@csrf
						...
						<div class="form-group">
                            ...
                            <input type="text" oninput="autofill('dosen')" class="dosen form-control @error('nip') is-invalid @enderror" id="nip" placeholder="Masukkan NIP Dosen" name="nip" value="{{ $kegiatan->dosen['nip'] }}">
                        	@error('nip')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						...
						<div class="form-group">
							...
							<input type="text" class="dosen form-control @error('nama_dosen') is-invalid @enderror" disabled="disable" id="nama_dosen" placeholder="" name="nama_dosen" value="{{ $kegiatan->dosen['nama_dosen'] }}">
						</div>
						...
						<div class="form-group">
								<label for="exampleFormControlInput1">Tanggal Kegiatan<span class="danger" style="color: #DC143C;">*</span></label>
									<input id="waktu" class="date-picker form-control @error('waktu') is-invalid @enderror" placeholder="dd-mm-yyyy" type="text" required="required" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" name="waktu" value="{{ $kegiatan->waktu }}">
										<script>
						...
						<select name="peran_id" class="form-control @error('peran_id') is-invalid @enderror">
							<option value="{{ $kegiatan->peran_id }}">Pilih Kategori Peran</option>
