		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
				    ...
				    <h2>Form Tambah Data Capaian</h2>
					<ul class="nav navbar-right panel_toolbox"></ul>
					<div class="clearfix"></div>
			    </div>

					<form role="form" action="{{ route('capaian.store') }}" method="post">
					@csrf
                            ...
                            <label for="exampleFormControlInput1">Tahun Lulus<span class="danger" style="color: #DC143C;">*</span></label>
                                ...
                                <option value="">Pilih Tahun</option>
                                    @for ($year = date('Y') - 7; $year < date('Y') + 10; $year++)
                                        <option value="{{$year}}" {{ old('tahun') == $capaian ? 'selected': ''}}>{{$year}}</option>
                                    @endfor
                               </select>
							@error('tahun')
								<div class="invalid-feedback">{{ $message }}</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control @error('minimum') is-invalid @enderror" id="exampleFormControlInput1" placeholder="" name="minimum" value="{{ old ('minimum') }}">
                        ...
                        <div class="form-group">
							...
							<input type="text" class="form-control @error('maksimum') is-invalid @enderror" id="exampleFormControlInput1" placeholder="" name="maksimum" value="{{ old ('maksimum') }}">
                        ...
                        <div class="form-group">
							...
							<input type="text" class="form-control @error('rata') is-invalid @enderror" id="exampleFormControlInput1" placeholder="" name="rata" value="{{ old ('rata') }}">
