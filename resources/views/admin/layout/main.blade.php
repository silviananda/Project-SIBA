...
<html lang="en">
  <head>
	...
	<link rel="icon" href="{{ env('APP_URL') }}/images/favicon.ico" type="image/ico" />
    ...
    <!-- bootstrap-wysiwyg -->
    <link href="{{ env('APP_URL') }}/vendors/google-code-prettify/bin/prettify.min.css" rel="stylesheet">
    <!-- Select2 -->
    <link href="{{ env('APP_URL') }}/vendors/select2/dist/css/select2.min.css" rel="stylesheet">
    <!-- Switchery -->
    <link href="{{ env('APP_URL') }}/vendors/switchery/dist/switchery.min.css" rel="stylesheet">
    <!-- starrr -->
    <link href="{{ env('APP_URL') }}/vendors/starrr/dist/starrr.css" rel="stylesheet">

    <!-- Datatables -->

    <link href="{{ env('APP_URL') }}/vendors/datatables.net-bs/css/dataTables.bootstrap.min.css" rel="stylesheet">
    <link href="{{ env('APP_URL') }}/vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css" rel="stylesheet">
    <link href="{{ env('APP_URL') }}/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css" rel="stylesheet">
    <link href="{{ env('APP_URL') }}/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css" rel="stylesheet">
    <link href="{{ env('APP_URL') }}/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="{{ env('APP_URL') }}/build/css/custom.min.css" rel="stylesheet">


    <link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}/vendors/datetimepicker/jquery.datetimepicker.css">
...
@yield ('content')
    ...
    <!-- jQuery -->
    <script src="{{ env('APP_URL') }}/vendors/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="{{ env('APP_URL') }}/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <!-- FastClick -->
    ...
    <script src="{{ env('APP_URL') }}/vendors/Flot/jquery.flot.time.js"></script>
    ...
    <!-- Flot plugins -->
    <script src="{{ env('APP_URL') }}/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
    <script src="{{ env('APP_URL') }}/vendors/DateJS/build/date.js"></script>
    <!-- JQVMap -->
    <script src="{{ env('APP_URL') }}/vendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    <!-- bootstrap-daterangepicker -->
    ...
    <!-- Datatables -->
    <script src="{{ env('APP_URL') }}/vendors/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-buttons-bs/js/buttons.bootstrap.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-buttons/js/buttons.flash.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-buttons/js/buttons.html5.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-buttons/js/buttons.print.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-keytable/js/dataTables.keyTable.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-responsive-bs/js/responsive.bootstrap.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/datatables.net-scroller/js/dataTables.scroller.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/jszip/dist/jszip.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/pdfmake/build/pdfmake.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/pdfmake/build/vfs_fonts.js"></script>


    <!-- bootstrap-wysiwyg -->

    <script src="{{ env('APP_URL') }}/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/jquery.hotkeys/jquery.hotkeys.js"></script>
    <script src="{{ env('APP_URL') }}/vendors/google-code-prettify/src/prettify.js"></script>
    <!-- jQuery Tags Input -->
    <script src="{{ env('APP_URL') }}/vendors/jquery.tagsinput/src/jquery.tagsinput.js"></script>
    <!-- Switchery -->
    <script src="{{ env('APP_URL') }}/vendors/switchery/dist/switchery.min.js"></script>
    <!-- Select2 -->
    <script src="{{ env('APP_URL') }}/vendors/select2/dist/js/select2.full.min.js"></script>
    <!-- Parsley -->
    <script src="{{ env('APP_URL') }}/vendors/parsleyjs/dist/parsley.min.js"></script>
    <!-- Autosize -->
    <script src="{{ env('APP_URL') }}/vendors/autosize/dist/autosize.min.js"></script>
    <!-- jQuery autocomplete -->
    <script src="{{ env('APP_URL') }}/vendors/devbridge-autocomplete/dist/jquery.autocomplete.min.js"></script>
    <!-- starrr -->
    <script src="{{ env('APP_URL') }}/vendors/starrr/dist/starrr.js"></script>

    <script src="{{ env('APP_URL') }}/vendors/datetimepicker/build/jquery.datetimepicker.full.js"></script>
