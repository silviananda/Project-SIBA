		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
				    ...
				    <h2>Form Tambah Data Prasarana Penunjang</h2>
					<ul class="nav navbar-right panel_toolbox"></ul>
					<div class="clearfix"></div>
			    </div>

					<form role="form" action="{{ route('prasarana.prasarana-lain.store') }}" method="post">
					@csrf
						...
						<div class="form-group">
							...
							<input type="text" class="form-control @error('unit_pengelola') is-invalid @enderror" id="exampleFormControlInput1" placeholder="" name="unit_pengelola" value="{{ old ('unit_pengelola') }}">
