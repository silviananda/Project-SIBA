		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
				    ...
				    <h2>Form Tambah Data Struktur Kurikulum</h2>
					<ul class="nav navbar-right panel_toolbox"></ul>
					<div class="clearfix"></div>
			    </div>

					<form role="form" action="{{ route('kurikulum.struktur.store') }}" method="post" enctype="multipart/form-data">
					@csrf
                            ...
                            <label for="exampleFormControlInput1">Tahun</label>
                                ...
                                <option value="">Pilih Tahun</option>
                                    @for ($year = date('Y') - 7; $year < date('Y') + 10; $year++)
                                        <option value="{{$year}}" {{ old('tahun') == $data ? 'selected': ''}}>{{$year}}</option>
                                    @endfor
                               </select>
                        </div> --}}
                        ...
                        <div class="form-group">
							...
							<input type="text" class="form-control @error('nama_mk') is-invalid @enderror" placeholder="" name="nama_mk" value="{{ old ('nama_mk') }}">
						...
						<div class="col-md-6 col-sm-12  form-group">
                            <label for="exampleFormControlInput1">Sks Matakuliah<span class="danger" style="color: #DC143C;">*</span></label>
							    <input type="text" class="form-control @error('bobot_sks') is-invalid @enderror" placeholder="" name="bobot_sks" value="{{ old ('bobot_sks') }}">
                        ...
                        <div class="col-md-6 col-sm-12  form-group">
							<label for="exampleFormControlInput1">Sks Praktikum</label>
                                <input type="text" class="form-control @error('sks_praktikum') is-invalid @enderror" placeholder="" name="sks_praktikum" value="{{ old ('sks_praktikum') }}">
                        ...
                        <div class="col-md-6 col-sm-12  form-group">
                            <label for="exampleFormControlInput1">Sks Seminar</label>
                                <input type="text" class="form-control @error('sks_seminar') is-invalid @enderror" placeholder="" name="sks_seminar" value="{{ old ('sks_seminar') }}">
                        ...
                        <div class="col-md-6 col-sm-12  form-group">
							<label for="exampleFormControlInput1">Sks Tugas</label>
                                <input type="text" class="form-control @error('bobot_tugas') is-invalid @enderror" placeholder="" name="bobot_tugas" value="{{ old ('bobot_tugas') }}">
                        ...
                        <div class="form-group">
							...
							<input type="text" class="form-control @error('unit') is-invalid @enderror" placeholder="" name="unit" value="{{ old ('unit') }}">
