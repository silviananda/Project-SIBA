		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
				    ...
				    <h2>Form Ubah Data Mahasiswa Asing</h2>
					<ul class="nav navbar-right panel_toolbox"></ul>
					<div class="clearfix"></div>
			    </div>

					<form role="form" action="{{ route('mahasiswa-asing.biodata.update', $mhs_asing->id) }}" method="post">
					@method('patch')
					@csrf
						...
						<div class="form-group">
							...
							@enderror
							<!-- <input type="text" class="form-control @error('id_jurusan') is-invalid @enderror" id="exampleFormControlInput1" placeholder="hide" value="{!! Auth::user()->kode_ps !!}" name="id_jurusan"> -->
						</div>

						<div class="form-group">
							<label for="exampleFormControlInput1">Nomor Induk Mahasiswa<span class="danger" style="color: #DC143C;">*</span></label>
							<input type="text" class="form-control @error('npm') is-invalid @enderror" id="exampleFormControlInput1" placeholder="" name="npm" value="{{ $mhs_asing->npm }}">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control @error('nama') is-invalid @enderror" id="exampleFormControlInput1" placeholder="" name="nama" value="{{ $mhs_asing->nama }}">
						...
						<div class="form-group">
								...
								<input type="text" oninput="autofill('dosen-wali')" class="dosen-wali form-control @error('nip') is-invalid @enderror" id="nip" placeholder="Masukkan NIP Dosen" name="nip" value="{{ $mhs_asing->dosen['nip'] }}">
						...
						<div class="form-group">
							...
							<input type="text" disabled="disabled" class="dosen-wali form-control @error('nama_dosen') is-invalid @enderror" id="nama_dosen" placeholder="" name="nama_dosen" value="{{ $mhs_asing->dosen['nama_dosen'] }}">

						</div>

						<div class="form-group form-material row">
							<input type="hidden" class="dosen-wali form-control @error('dosen_id') is-invalid @enderror" id="dosen_id" placeholder="" name="dosen_id" value="{{ $mhs_asing->dosen_id }}">
						</div>

						<div class="form-group">
							<label for="exampleFormControlInput1">Jenis Kelamin<span class="danger" style="color: #DC143C;">*</span></label>
							<p>
								Laki-laki:       <input type="radio" class="flat" name="jenis_kelamin" id="" value="Laki-laki" checked="" required />
								Perempuan:       <input type="radio" class="flat" name="jenis_kelamin" id="" value="Perempuan" checked="" required/>
							</p>
						</div>

						<label for="exampleFormControlInput1">Tempat Tinggal Asal<span class="danger" style="color: #DC143C;">*</span></label>
						<select name="asal_id" disabled="disabled" class="form-control @error('asal_id') is-invalid @enderror">
							<option value="">Pilih Asal</option>
								@foreach ($kategori_asal as $data)
									<option value="{{ $data->id }}" {{$data->id == $mhs_asing->asal_id ? 'selected' : ''}} >{{ $data->asal}}</option>
								@endforeach
						</select>
							@error('asal_id')
								<div class="invalid-feedback">{{ $message }}</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control @error('asal_sekolah') is-invalid @enderror" id="exampleFormControlInput1" placeholder="" name="asal_sekolah" value="{{ $mhs_asing->asal_sekolah }}">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Tahun Masuk<span class="danger" style="color: #DC143C;">*</span></label>
                                <input id="tahun_masuk" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" onfocus="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" name="tahun_masuk" value="{{ $mhs_asing->tahun_masuk }}">
                                    <script>
						...
						<select name="jalur_masuk_id" disabled="disabled" class="form-control @error('jalur_masuk_id') is-invalid @enderror">
							<option value="">Pilih Jalur Masuk</option>
								@foreach ($kategori_jalur as $data)
									<option value="{{ $data->id }}" {{$data->id == $mhs_asing->jalur_masuk_id ? 'selected' : ''}} >{{ $data->jalur_masuk}}</option>
								@endforeach
						</select>
						...
						<div class="form-group">
							...
							<input type="email" class="form-control @error('email') is-invalid @enderror" id="exampleFormControlInput1" placeholder="" name="email" value="{{ $mhs_asing->email }}">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control @error('ipk') is-invalid @enderror" id="exampleFormControlInput1" placeholder="" name="ipk" value="{{ $mhs_asing->ipk }}">
					...
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-12  form-group">
									...
									<input type="text" disabled="disabled" class="doping2 form-control @error('nama_dosen') is-invalid @enderror" id="nama_dosen" placeholder="" name="nama_dosen" value="{{ $listdoping2[0][0]['nama_dosen'] ?? '-'}}">
								</div>

								<div class="form-group form-material row">
									<input type="hidden" class="doping2 form-control @error('doping2') is-invalid @enderror" id="dosen_id" placeholder="" name="doping2" value="{{ $listdoping2[0][0]['dosen_id'] ?? '-'}}">
								</div>
                                ...
                                <div class="col-md-12 col-sm-12 form-group">
                                    <label for="exampleFormControlInput1">Tahun Lulus</label>
                                        <input id="tahun_keluar" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" onfocus="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" name="tahun_keluar" value="{{ $mhs_asing->tahun_keluar }}">
                                            <script>
                                                function timeFunctionLong(input) {
                                                setTimeout(function() {
                                                    input.type = 'text';
                        ...
                        <a href="{{ route('mahasiswa-asing.biodata.index') }}" class="btn btn-danger" style="float: right;">Batal</a>
