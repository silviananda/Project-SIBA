    ...
    <div class="">
        <div class="col-md-12 col-sm-12">
            <div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
                <div class="x_title">
                    <h2>Form Tambah Data Aktivitas Dosen Tetap</h2>
                    <ul class="nav navbar-right panel_toolbox"></ul>
                    <div class="clearfix"></div>
                </div>

                <form role="form" action="{{ route('dosen.tetap.aktivitas.store') }}" method="post">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled="disabled" class="dosen-tetap form-control @error('nama_dosen') is-invalid @enderror" id="nama_dosen" placeholder="" name="nama_dosen" required="required">
                                    </div>
                                    ...
                                    <div id="ps_sendiri_fields" class="form-group">
                                        ...
                                        <div class="input-ps-sendiri form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" oninput="autofillmk('kode_mk')" class="kode_mk form-control" id="kode_mk" placeholder="Masukkan Kode MK" name="kode_mk[]" required>
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-12 form-group">
                                                    ...
                                                    <input id="deadline" class="date-picker form-control  @error('deadline') is-invalid @enderror" placeholder="dd-mm-yyyy" type="text" required="required" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" name="deadline" value="{{ old ('deadline') }}">
                                                    <script>
