		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
                    ...
                    <form role="form" action="{{ route('dosen.tetap.biodata.update', $dosen->dosen_id) }}" method="post">
                        @method('patch')
                        @csrf
						...
						<div class="form-group">
							...
							<input type="text" disable="disabled" class="form-control @error('nama_dosen') is-invalid @enderror" placeholder="" name="nama_dosen" value="{{ $dosen->nama_dosen }}">
						...
						<select name="pendidikan_id" class="form-control @error('pendidikan_id') is-invalid @enderror" required="required">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="otherField1">Pendidikan S2<span class="danger" style="color: #DC143C;">*</span></label>
                                        <input type="text" class="form-control w-100 @error('pend_s2') is-invalid @enderror" id="otherField1" name="pend_s2" value="{{ $dosen->pend_s2 }}">
                        ...
                        <div class="form-group">
								<label for="exampleFormControlInput1">Tanggal Lahir<span class="danger" style="color: #DC143C;">*</span></label>
									<input id="tgl_lahir" class="date-picker form-control @error('tgl_lahir') is-invalid @enderror" placeholder="dd-mm-yyyy" type="text" onfocus="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)" name="tgl_lahir" value="{{ $dosen->tgl_lahir }}">
										<script>
                        ...
                        <a href="{{ route('dosen.tetap.biodata.index') }}" class="btn btn-danger" style="float: right;">Batal</a>
