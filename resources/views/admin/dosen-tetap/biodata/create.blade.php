		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
					...
					<form role="form" action="{{ route('dosen.tetap.biodata.store') }}" method="post">
					@csrf
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="otherField1">Pendidikan S2<span class="danger" style="color: #DC143C;">*</span></label>
                                        <input type="text" class="form-control w-100 @error('jabatan_id') is-invalid @enderror" id="otherField1" name="pend_s2" value="S2-">
