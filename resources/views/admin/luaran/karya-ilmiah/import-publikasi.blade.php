		...
		<div class="col-md-12 col-sm-12">
			<div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
				<div class="x_title">
				    ...
				    <h2>Import Data Publikasi Dosen</h2>
					<ul class="nav navbar-right panel_toolbox"></ul>
					<div class="clearfix"></div>
			    </div>

                <form role="form" action="{{ route('luaran.karya-ilmiah.import.store') }}" method="post" enctype="multipart/form-data">
					@csrf

						<div class="form-group">
							<label for="softcopy">Data Publikasi</label>
						...
						<div class="form-group">
							<label for="softcopy"><span class="danger" style="color: #DC143C;">*  Contoh Format File yang Dapat di Import</span></label>
                                ...
                                <img src="/assets/images/excel.png" height="50" width="50">
             						<span class="count_top"><i class=""></i> publikasi.xlsx </span>
                                ...
                                <div class="message_wrapper">
                                  <p class="url">
                                    ...
                                    <a href="{{ asset('file/publikasi.xlsx') }}" target="_blank" data-original-title="">Download</a>
                                  </p>
                                </div>
								</div>
						</div>
