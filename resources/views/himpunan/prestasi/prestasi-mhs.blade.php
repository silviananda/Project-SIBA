                ...
                <div class="x_panel shadow-sm p-3 mb-5 bg-white rounded">
                  <div class="x_title">
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><a class="" style="color: #778899" href="{{ route('prestasi.create') }}"> Tambah <i class="fa fa-plus"></i></a>
                      </li>
                    </ul>
                          ...
                          <table id="datatable-fixed-header" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                ...
                                @foreach ( $prestasi_mhs as $value )
                                    ...
                                    <a href="{{ route('prestasi.edit', $value->id) }}" class="btn btn-success btn-sm">Ubah</a>

                                      <a href="#" data-id="{{ $value->id }}" class="btn btn-danger btn-sm swal-confirm">
                                        <form class="d-inline" action="{{ route('prestasi.delete', $value->id) }}" id="delete{{ $value->id }}" method="post">
                                          @method('delete')
                                          @csrf
                                        </form>
                                      Hapus</a>
